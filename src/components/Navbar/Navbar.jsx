...
import NotificationModal from "../UI/Modals/Notification/NotificationModal";
...
const Navbar = () => {
  ...
  return (
    <>
              ...
              <div className="flex gap-x-3 items-center">
                ...
                <div className="relative">
                  <button
                    ...
                    className="font-medium text-xl bg-white text-primary border border-primary px-4 py-2 rounded-full"
                  >
                    <IoIosNotifications />
                  </button>
                  <span className="w-5 h-5 bg-primary text-white -top-1 -right-1 absolute flex justify-center items-center rounded-full text-xs">
                    0
                  </span>
                </div>
                <button
      ...
      {isNotification && (
        <NotificationModal setIsNotification={setIsNotification} />
      )}
    </>
  );
};
