    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-gradient-to-br from-primary dark:from-darkPrimary dark:to-darkBox  border border-transparent dark:border-darkBorder  to-primaryDark p-6 rounded-lg w-full max-w-lg shadow-xl cursor-default relative "
        >
