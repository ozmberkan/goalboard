...
const ProjectBox = ({ project, teamUsers }) => {
  return (
    <Link
      ...
      className="bg-project-bg bg-cover bg-center lg:h-[150px] h-[170px] bg-no-repeat hover:shadow-2xl transition-all duration-300 border-2 rounded-xl  p-5 flex flex-col justify-between items-start"
    >
      <div className="flex  gap-y-5 items-center justify-between w-full ">
        ...
        <div className="font-semibold lg:text-sm text-xs bg-zinc-50 rounded-full border text-zinc-700  px-6 py-2 flex gap-x-3 items-center">
          <FaCalendarCheck />
