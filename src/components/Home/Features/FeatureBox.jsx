const FeatureBox = ({ feature }) => {
  ...
  return (
    <div className="w-full bg-gradient-to-tr ring-2 ring-offset-1 ring-baseDark from-base to-baseDark  shadow-md justify-start items-start rounded-md p-5 flex flex-col gap-y-5 relative">
