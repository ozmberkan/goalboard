const Announcements = () => {
  return (
    <div className="flex-grow p-4 flex ">
      <div className="w-full border bg-white dark:bg-darkBox dark:border-darkBorder rounded-md p-8 flex flex-col gap-y-4 relative  overflow-hidden transition-all duration-500">
        ...
        <div className="py-2 w-full lg:flex grid grid-cols-1 gap-5">
          <p className="bg-orange-100 text-orange-500 dark:bg-darkPrimary transition-colors duration-500   rounded-md font-semibold  text-sm px-4 py-2 ">
            Görev atama süreçleri daha hızlı ve sezgisel hale getiriliyor
          </p>
          <p className="bg-red-100 text-red-500 dark:bg-darkPrimary transition-colors duration-500   rounded-md  font-semibold text-sm px-4 py-2 ">
            Mobil uyum süreci devam ediyor
          </p>
          <p className="bg-blue-100 text-blue-500  dark:bg-darkPrimary transition-colors duration-500  rounded-md font-semibold  text-sm px-4 py-2 ">
            Performans ve stabilite üzerinde çalışıyoruz
          </p>
          <p className="bg-violet-100 text-violet-500 dark:bg-darkPrimary transition-colors duration-500   rounded-md font-semibold  text-sm px-4 py-2 ">
