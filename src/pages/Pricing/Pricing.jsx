...
const Pricing = () => {
  return (
    <div className="flex-grow flex items-center justify-start flex-col relative p-24 gap-y-5">
      <Link
        to="/"
      ...
      <div className="flex flex-col gap-y-3 items-center justify-center z-10">
        <motion.h1
      ...
      <motion.div
        ...
        className="w-full  flex justify-center items-center z-10 p-5 h-[500px]"
      >
        <PricingCard />
      </motion.div>
    </div>
